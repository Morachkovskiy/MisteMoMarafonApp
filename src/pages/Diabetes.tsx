  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 space-y-6">
          ...
          <div className="flex items-center p-6 min-h-[200px]">
            <div className="flex-1 text-primary-foreground">
              ...
              <p className="text-primary-foreground/90 text-sm leading-relaxed">
                ...
                Специалист по лечению и профилактике диабета.
              </p>
            </div>
        ...
        {/* Обучающие видео */}
        <div>
          <h2 className="text-lg font-semibold mb-4">Лечение диабета</h2>
          <div className="grid grid-cols-1 gap-4">
            {[
              {
                title: 'Основы лечения диабета',
                description: 'Комплексный подход к лечению сахарного диабета',
                youtubeId: 'ZU2yWlpmjNA'
              },
              {
                title: 'Питание при диабете',
                description: 'Правильное питание для контроля уровня сахара',
                youtubeId: 'ZU2yWlpmjNA'
              },
              {
                title: 'Профилактика осложнений',
                description: 'Как предотвратить осложнения диабета',
                youtubeId: 'ZU2yWlpmjNA'
              }
            ].map((video, index) => (
