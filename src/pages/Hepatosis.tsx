...
export default function Hepatosis() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="bg-primary px-4 py-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-xl font-bold text-primary-foreground">
            Гепатоз - Лечение и Профилактика
          </h1>
        </div>
      </div>
      ...
      <div className="p-4 space-y-6">
          ...
          <div className="flex items-center p-6 min-h-[200px]">
            <div className="flex-1 text-primary-foreground">
              ...
              <p className="text-primary-foreground/90 text-sm leading-relaxed">
                ...
                Специалист по лечению заболеваний печени.
              </p>
            </div>
        ...
        {/* Обучающие видео */}
        <div>
          <h2 className="text-lg font-semibold mb-4">Лечение гепатоза</h2>
          <div className="grid grid-cols-1 gap-4">
            {[
              {
                title: 'Жировой гепатоз печени',
                description: 'Причины развития и современные методы лечения',
                youtubeId: 'ZU2yWlpmjNA'
              },
              {
                title: 'Детоксикация печени',
                description: 'Естественные методы очищения и восстановления печени',
                youtubeId: 'ZU2yWlpmjNA'
              },
              {
                title: 'Питание для здоровья печени',
                description: 'Диета и рекомендации по питанию при гепатозе',
                youtubeId: 'ZU2yWlpmjNA'
              }
            ].map((video, index) => (
