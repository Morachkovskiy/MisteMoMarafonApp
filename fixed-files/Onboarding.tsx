...
export default function Onboarding() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Используем наш API вместо прямого fetch
      const result = await api.saveOnboarding(user?.id || 'anonymous', formData);
    ...
    // Устанавливаем флаг завершения анкеты
    localStorage.setItem('onboarding_done', 'true')
    console.log('Onboarding completed, redirecting to pricing');
